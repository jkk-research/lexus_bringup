...
sleep 1
echo "[INFO] Starting os_32_right_b"
screen -dmS os_32_right_b bash -c 'ros2 launch lexus_bringup os_32_right_b.launch.py'
sleep 4
...
sleep 12
echo "[INFO] Starting os_64_center_b"
screen -dmS os_64_center_b bash -c 'ros2 launch lexus_bringup os_64_center_b.launch.py'
