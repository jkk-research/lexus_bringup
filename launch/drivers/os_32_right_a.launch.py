...
def generate_launch_description():
    ...
    params_declare = DeclareLaunchArgument('params_file', default_value=os.path.join(share_dir, 'launch', 'drivers', 
                                            'ouster_config_a.yaml'), description='FPath to the ROS2 parameters file to use.')
